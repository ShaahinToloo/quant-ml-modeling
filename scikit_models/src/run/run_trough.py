...
from scikit_models.src.data_preprator import DataPreprator
from scikit_models.src.run import Run
...
class RunTrough(Run):
    ...
    def calculate_labels(
        ...
        if not os.path.exists(obj_full_path):
            ...
            _, self.labels = labeling_obj.get_label_arrays()
    ...
    def _get_Xy_arr(self):
        ...
        data_preprator_obj = DataPreprator(
    ...
    def get_model_data(
        ...
        std_scaler_obj.export_to_json("mlp_c_b_trough_std_scaler.json")
