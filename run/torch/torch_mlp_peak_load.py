...
run_obj = RunPeak(fractals_period, model_seq_len, model_look_ahead, df, main_dir)
...
run_obj.create_data_loaders(
    batch_size=1024, val_size=0.15, test_size=0.90, do_shuffle=True
)
...
joblib.dump(iso, "resources/torch/peak/isotonic_scaler.pkl")
...
x_points = iso.X_thresholds_  # probs
